...
public class Contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etContrasena = (EditText) findViewById(R.id.etContrasena);
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if(sesion!=null){
                        ...
                        message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("gucho35.enp9@gmail.com"));
